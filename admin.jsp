            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
              ...
              <span class="icon-bar"></span>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="properties.jsp"
						class="nav-link">Properties</a></li>
<!-- 					<li class="nav-item active"><a href="admin.jsp"
						class="nav-link">Admin</a></li>
						  <ul class="nav navbar-nav">
              <li><a href="index.jsp">Home</a></li>
 -->              <li><a href="admin.jsp">Admin<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="adminlogin.jsp">Login</a></li>
                  <li><a href="account.jsp">Sell</a></li></ul>
                </ul></li>
					<li class="nav-item active"><a href="account.jsp"
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					...
					<h1 class="mb-3 bread">Our Admin</h1>
				</div>
			</div>
		</div>
	</section>
